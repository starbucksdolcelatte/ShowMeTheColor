    ...
    function l(r) {
        for (var t = 1; t < arguments.length; t++) {
            ...
            "function" == typeof Object.getOwnPropertySymbols && (
                e = e.concat(Object.getOwnPropertySymbols(o).filter(function (t) {
                    return Object
            ...
            ot = function () {
                ...
                t._addEventListeners = function () {
                    ...
                    "hover" === this._config.pause && (
                        P(this._element).on(Q.MOUSEENTER, function (t) {
                            return e.pause(t)
...
Bn = (
            ...
            Tt = function () {
                function a(e, t) {
                    ...
                    this._triggerArray = st.makeArray(document.querySelectorAll(
                ...
                t.show = function () {
                    ...
                    if (!this._isTransitioning && !st(this._element).hasClass(gt) && (
                        this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(Et)).filter(function (t) {
                            ...
                            if (0 < i) 
                                for (var r = 0; r < i; r++) {
                                    var o = this._triggerArray[r],
                                        s = Fn.getSelectorFromElement(o);
                                    if (null !== s) 
                                        st([].slice.call(document.querySelectorAll(s))).hasClass(gt) || st(o)
                                            .addClass(
                                                pt
                                            )
...
Vn = (
                    ...
                    return this.each(function () {
                        ...
                        if (t || (t = new c(
                            ...
                            "object" == typeof e
                                ? e
                                : null
                        ), bt(this).data(It, t)), "string" == typeof e) {
            ...
            bt(document).on(Ot.KEYDOWN_DATA_API, Wt, Gt._dataApiKeydownHandler).on(
                Ot.KEYDOWN_DATA_API,
                qt,
                Gt._dataApiKeydownHandler
            ).on(Ot.CLICK_DATA_API + " " + Ot.KEYUP_DATA_API, Gt._clearMenus).on(
                Ot.CLICK_DATA_API,
                Wt,
                function (t) {
                    t.preventDefault(),
            ...
            We = function () {
                ...
                t.show = function () {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        ...
                        pe.contains(this.element.ownerDocument.documentElement, this.tip) || pe(i).appendTo(
                            a
                        ),
            ...
            Tn = function () {
                function n(t, e) {
                    ...
                    this._scrollElement = "BODY" === t.tagName
                        ...
                        : t,
                    this._config = this._getConfig(e),
                    this._selector = this._config.target + " " + gn + "," + this._config.target +
                            " " + mn + "," + this._config.target + " " + vn,
                    this._offsets = [],
                    this._targets = [],
